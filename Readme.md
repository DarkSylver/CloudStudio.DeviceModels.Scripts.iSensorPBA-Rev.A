...
# Parsing + Configuration Script – iSensorPBA - Rev. A

This **Parsing + Configuration** script is designed for the **iSensorPBA** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – iSensorPBA Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **iSensorPBA** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
